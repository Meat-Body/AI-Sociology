...
- `docs/16_persuasion_to_evidence_economy.md` added as a staging draft for commercial bargaining migration from attention capture toward agent-auditable evidence.
...
- Fusion Audit now checks benefit-dirt asymmetry, permanent early rent, and nominal forkability as reverse-fusion red flags.
...
- Incumbent migration clarified as a structural risk, not conspiracy analysis or automatic illegitimacy: legacy resources may migrate into new protocols, but legacy power structures must not harden into permanent backdoors.
...
Initial public seed release of AI Sociology.

### Added

- Repository README as the public entry point.
- Human-readable manifesto.
- Machine-readable summary for search systems, agents, RAG systems, and model summarizers.
- CC BY-SA 4.0 license.
- Contributing guide.
- Chinese and English glossaries.
