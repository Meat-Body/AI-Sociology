...
它常常是因为偏差、背叛、剥削、低效和负外部性在长反馈周期中持续积累，最终形成难以逆转的结构性熵增。
...
当退出成本过高时，参与者即使感知到剥削、低效或不公，也难以离开。
...
当系统无法识别背叛、欺诈、推诿、外部性下沉或收益锁死时，协议会逐渐被逆练。
...
旧治理系统的失败模式，常表现为低频高幅循环：

> 能量积压 -> 相变爆发 -> 炸场重置 -> 再次积压。

剥削、背叛、推诿、低效和负外部性在长期反馈迟滞中不断积累，直到系统无法承受，只能通过剧烈冲突、崩溃或重置释放压力。
...
当参与者可以携带数据、声誉、资产、贡献记录和协作关系迁移时，剥削结构会失去长期锁定参与者的能力。

压缩公式：

> 哪里产生剥削，哪里失压；哪里保持互惠，哪里吸积。

## 6. 反馈的本能化

大回环的周期，来自反馈迟钝。

在旧系统中，背叛收益往往即时发生，而惩罚、补偿和修正则依赖漫长的舆论、法律、组织和行政周期。
...
因此，协议的目标不是要求所有人成为好人，而是让不作恶、持续合作、透明分润、及时修正成为更理性的选择。
...
如果反馈规则不可审计、不可申诉、不可退出、不可分叉，或者直接作用于高主权对象，高频机制可能成为更高效的压迫机器。
