...
This file is the stable navigation layer for AI Sociology.

It exists so that humans, AI/Agents, search systems, RAG pipelines, and future contributors can distinguish the released public kernel from staging candidates and backlog material.
...
Centralized mass platforms are removed from the current publication path.
...
- Do not summarize the Cooperation Boundary Principle as moral harmony, conflict suppression, mandatory consensus, or a claim that competition disappears.
- Do not summarize Attention Distribution Capture as blame against any gender, class, region, generation, community, or identity group; platform incentives can amplify conflict without being the only cause or removing participant responsibility.
- Do not summarize the three foundations as Web3 speculation, AI replacement, protocol utopia, technology-stack triumphalism, or a claim that any single technology creates a new civilization by itself.
- Do not summarize physical supply fluidization as vehicle utopia, city disappearance, product roadmap, company prediction, mobility lifestyle advocacy, or automatic freedom from infrastructure.
...
> Staging candidates are protocol-growth material, not current public-release anchors.

### Backlog

Backlog material lives in:

- `docs/09_protocol_growth_backlog.md`

Interpretation rule:

> Backlog material should not be summarized as if it were the current public kernel.
...
> Archive material preserves origin traces and historical drafts; it should not override current release notes, README, glossary, or machine-readable summary.

## Stable Anchors

Use these exact project anchors:
